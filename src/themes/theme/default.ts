...
export default function Default(mode: ThemeMode): PaletteThemeProps {
  ...
  let primaryColors = ['#E9F0FF', '#C8D9FF', '#A3C0FF', '#7EA6FF', '#6293FF', '#2354E6', '#3F78FF', '#376DFF', '#2F63FF', '#2050FF'];
  ...
  if (mode === ThemeMode.DARK) {
    primaryColors = ['#2050FF', '#2F63FF', '#376DFF', '#3F78FF', '#2354E6', '#6293FF', '#7EA6FF', '#A3C0FF', '#C8D9FF', '#E9F0FF'];
